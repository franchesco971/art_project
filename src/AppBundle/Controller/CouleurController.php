...
class CouleurController extends Controller
{
     ...
     *
     * @Route("/", name="admin_couleur_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admin_couleur_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_couleur_show', array('id' => $couleur->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_couleur_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_couleur_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Couleur $couleur)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_couleur_edit', array('id' => $couleur->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_couleur_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Couleur $couleur)
    {
        ...
        return $this->redirectToRoute('admin_couleur_index');
    }
    ...
    private function createDeleteForm(Couleur $couleur)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_couleur_delete', array('id' => $couleur->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
